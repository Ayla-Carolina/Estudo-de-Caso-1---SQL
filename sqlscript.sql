REM   Script: Estudo de caso SIP - SQL
REM   Estudo de caso SIP - TUDO Implanta 
...
COMMENT COLUMN t_sip_departamento.cd_depto IS 
...
ADD CONSTRAINTS ck_sip_func_salario 
CHECK (val_salario_mensal >= 1212);

ALTER TABLE t_sip_funcionario 
ADD CONSTRAINTS pk_sip_funcionario 
...
DROP TABLE t_sip_departamento CASCADE CONSTRAINT;

DROP TABLE t_sip_dependente CASCADE CONSTRAINT;

DROP TABLE t_sip_funcionario CASCADE CONSTRAINT;

DROP TABLE t_sip_implantacao CASCADE CONSTRAINT;

DROP TABLE t_sip_projeto CASCADE CONSTRAINT;
